...
#define BNO055_ADDRESS DAQ_IMU_I2C_ADR
/** BNO055 ID **/
...
#define BNO055_RST_GPIO_Port 	DAQ_IMU_RST_GPIO_PORT
#define BNO055_RST_Pin			DAQ_IMU_RST_PIN
...
typedef struct {
  ...
  uint8_t z;
  uint8_t z_sign;
} adafruit_bno055_axis_map_t;

typedef enum {
  BNO055_AXIS_SIGN_POSITIVE = 0x00,
  BNO055_AXIS_SIGN_NEGATIVE = 0x01
}adafruit_bno055_axis_map_sign_t;

typedef enum {
  BNO055_AXIS_X = 0x00,
  BNO055_AXIS_Y = 0x01,
  BNO055_AXIS_Z = 0x02
}adafruit_bno055_axis_map_representation_t;
...
/*========================External Functions========================*/
void Adafruit_BNO055_WriteData(uint8_t reg, uint8_t data);
void Adafruit_BNO055_SetAxisMap(adafruit_bno055_axis_map_t axis);
