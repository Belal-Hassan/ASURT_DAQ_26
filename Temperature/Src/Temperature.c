...
void Temp_ReadRaw(uint8_t sensor_index)
{
		...
		HAL_I2C_Mem_Read(temp_hi2c, (TEMP_I2C_BASE_ADDRESS + sensor_index * TEMP_I2C_ADDRESS_SPACING) << 1, MLX90614_TOBJ_ADDR, I2C_MEMADD_SIZE_8BIT, temp_sensors_data[sensor_index].data, 3, HAL_MAX_DELAY);
}
